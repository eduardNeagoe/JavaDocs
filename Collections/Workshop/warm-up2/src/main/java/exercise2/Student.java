...
public class Student {
    ...
    public boolean equals(Object o) {
        ...
        if(!this.firstName.equals(stud.firstName)) return false;
        if(!this.lastName.equals(stud.lastName)) return false;
        if(!this.averageGrade.equals(stud.averageGrade)) return false;
        if(!this.id.equals(stud.id))return false;
